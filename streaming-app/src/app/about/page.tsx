...
export default function AboutPage() {
  const values = [
    ...
    { icon: Gamepad2, title: 'Gaming Passion', description: 'Dedicated to bringing you the best gaming moments and experiences.' },
    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none mb-12">
          <p>Welcome to {SITE_NAME}, a dedicated live streaming platform for gaming content. We focus on delivering high-quality gameplay streams, interactive experiences, and a vibrant community.</p>
          <p>Whether you are here to watch competitive gameplay, chill streams, or special events, we aim to provide an enjoyable experience for every viewer.</p>
        </div>
